...
INSERT INTO LEAD_CHURNS (FIRST_NAME,LAST_NAME,PATIENT_ID,ASSIGNED_USER_ID,FILTERED_OUT,FILTERED_BY_USER_ID,CREATED_AT,UPDATED_AT,DELETED_AT,CHURNED_OUTREACH_DATE)
VALUES ('{fname}','{lname}','{patient_id}',NULL,NULL, NULL,NOW(),NOW(),NULL, NULL) """
