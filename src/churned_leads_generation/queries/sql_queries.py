...
UPDATE_LEAD_CHURNS_SQL = """ UPDATE LEAD_CHURNS SET CREATED_AT = NOW(), UPDATED_AT = NOW(), PLAN_TYPE= '{plantype}', STATE = '{state}', PAYER_ID= '{payerid}' WHERE PATIENT_ID = '{patient_id}' """
